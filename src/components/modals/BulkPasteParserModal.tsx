      ...
      try {
        ...
        if (data.success && Array.isArray(data.questions) && data.questions.length > 0) {
          const formatted: Question[] = data.questions.map((q: any, idx: number) => ({
            ...
            source: q.source || (languageMode === "ar" ? "المناهج المعتمدة" : languageMode === "en" ? "Curriculum Reference" : "পাঠ্যবই ও রেফারেন্স"),
            difficulty: "Medium",
            exam_type: "NTRCA",
            language: languageMode,
    ...
    try {
      ...
      for (let i = 0; i < blocks.length; i++) {
        ...
        parsed.push({
          ...
          source: sourceText || (languageMode === "ar" ? "المناهج المعتمدة" : languageMode === "en" ? "Curriculum Reference" : "পাঠ্যবই ও রেফারেন্স"),
          difficulty: "Medium",
          exam_type: "NTRCA",
          language: languageMode,
          created_at: new Date().toISOString(),
