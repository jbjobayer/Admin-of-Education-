              ...
              {examQuestions.map((q, idx) => (
                ...
                >
                  {(() => {
                    ...
                    const isAr = qLang === "ar";
                    return (
                      <div className="space-y-1.5 min-w-0 flex-1" dir={isAr ? "rtl" : "ltr"}>
                        <div className="flex items-center gap-1.5" dir="ltr">
                          ...
                          {isAr && (
                            <span className="px-1.5 py-0.5 rounded text-[9px] bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300 font-bold">
                              عربي
                            </span>
                          )}
                        </div>

                        <p className={`font-bold text-slate-800 dark:text-white leading-snug ${isAr ? "font-arabic text-sm text-right" : "text-xs text-left"}`}>
                          {q.question}
                        </p>

                        {q.arabic_text && (
                          <p
                            className="font-arabic text-emerald-800 dark:text-emerald-300 text-xs font-semibold text-right leading-relaxed bg-emerald-50/50 dark:bg-emerald-950/30 p-1.5 rounded-lg"
                            dir="rtl"
                          >
                            {q.arabic_text}
                          </p>
                        ...
                        <div className="flex flex-wrap gap-1.5 text-[10px] text-slate-500 dark:text-slate-400 pt-0.5" dir={isAr ? "rtl" : "ltr"}>
                          {q.options.map((opt, oIdx) => {
                            const badge = getOptionLabel(oIdx, qLang);
                            ...
                            return (
                              ...
                              >
                                <strong>[{badge}]</strong>
                                <span className={isAr ? "font-arabic" : ""}>{opt}</span>
                              </span>
                            );
                          })}
                        </div>
